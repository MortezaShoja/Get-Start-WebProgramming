...
Public Class dsD
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsD = CType(MyBase.Clone,dsD)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsD"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/dsD.xsd"
    ...
    Public Class phonesDataTable
        ...
        Public Overloads Function AddphonesRow(ByVal Family As String, ByVal Name As String, ByVal Phone As String) As phonesRow
            ...
            rowphonesRow.ItemArray = New Object() {Nothing, Family, Name, Phone}
    ...
    Public Class phonesRow
        ...
        Public Property ID As Integer
            Get
                Return CType(Me(Me.tablephones.IDColumn),Integer)
            End Get
            Set
        ...
        Public Function IsFamilyNull() As Boolean
            Return Me.IsNull(Me.tablephones.FamilyColumn)
        End Function
        
        Public Sub SetFamilyNull()
            Me(Me.tablephones.FamilyColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsNameNull() As Boolean
            Return Me.IsNull(Me.tablephones.NameColumn)
        End Function
        
        Public Sub SetNameNull()
            Me(Me.tablephones.NameColumn) = System.Convert.DBNull
        End Sub
