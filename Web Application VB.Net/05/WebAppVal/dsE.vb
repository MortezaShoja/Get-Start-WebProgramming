...
Public Class dsE
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsE = CType(MyBase.Clone,dsE)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsE"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/dsE.xsd"
    ...
    Public Class EmployeesDataTable
        ...
        Public Overloads Function AddEmployeesRow(ByVal LastName As String, ByVal FirstName As String) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            rowEmployeesRow.ItemArray = New Object() {Nothing, LastName, FirstName}
